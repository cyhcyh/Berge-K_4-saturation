...
class MultiHypergraphGUI(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('Berge K_4 saturated uniform hypergraph judger')
    ...
    def batch_validate(self):
        ...
        for idx, hyperedges in enumerate(hypergraphs, 1):
            ...
            try:
                from is_saturated_v2 import is_berge_k4_saturated
                is_berge_k4_saturated(n_vertices, hyperedges)
            except Exception as e:
